 ...
 * @LastEditTime: 2020-11-09 16:50:34
 * @LastEditors: Liu Jing
 * @Description: 
 * @FilePath: \lxhf\app\Http\Controllers\Admin\IndexController.php
 */
...
class IndexController extends Controller
{
    ...
    {
        $user = Auth::user();
        return view('admin.layout',['userName'=>$user->name,'userId'=>$user->id]);
    }
    ...
    public function data(Request $request)
    {
        ...
        switch (strtolower($model)) {
            ...
            case 'permission':
                ...
                $query = $query->where('parent_id', $request->get('parent_id', 0))->with('icon')->orderBy('sort', 'desc');
                break;
            default:
                $query = new User();
                break;
