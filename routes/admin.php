...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'middleware' => ['auth', 'permission:zixun.manage']], function () {
    ...
    //产品分类管理
    Route::group(['middleware' => 'permission:zixun.product_category'], function () {
        Route::get('product_category/data', 'ProductCategoryController@data')->name('admin.product_category.data');
        Route::get('product_category', 'ProductCategoryController@index')->name('admin.product_category');
        //添加分类
        Route::get('product_category/create', 'ProductCategoryController@create')->name('admin.product_category.create');
        Route::post('product_category/store', 'ProductCategoryController@store')->name('admin.product_category.store');
        //编辑分类
        Route::get('product_category/{id}/edit', 'ProductCategoryController@edit')->name('admin.product_category.edit');
        Route::put('product_category/{id}/update', 'ProductCategoryController@update')->name('admin.product_category.update');
        //删除分类
        Route::delete('product_category/destroy', 'ProductCategoryController@destroy')->name('admin.product_category.destroy');
    });
    //产品管理
    Route::group(['middleware' => 'permission:zixun.product'], function () {
